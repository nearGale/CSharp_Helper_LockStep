...
namespace Game.Server
{
    public static partial class GameHelper_Server
    {
        ...
        public static void NotifyBattleStart(ClientSession conn = null)
        {
            ...
            if (conn != null)
            {
                NetworkServer.Instance.SendMessageToClient(conn.SessionId, EProtoType.BattleStartNtf, msg);
            }
            else
            {
                NetworkServer.Instance.BroadcastMessage(EProtoType.BattleStartNtf, msg);
            }
        }
        ...
        public static void NotifyBattleStop()
        {
            ...
            NetworkServer.Instance.BroadcastMessage(EProtoType.BattleStopNtf, msgRsp);
        }
    }
}
