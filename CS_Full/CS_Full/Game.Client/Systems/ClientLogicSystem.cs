...
namespace Game.Client
{
    ...
    public class ClientLogicSystem : Singleton<ClientLogicSystem>, IClientSystem
    {
        ...
        public void LogicUpdate()
        {
            ...
            if (!ClientRoomSystem.Instance.IsBattleRoomRunning() && clientTick > serverTick) 
                return; // 小于等于 serverTick 可以继续模拟到服务器帧号
        ...
        {
            if (!GameFacade_Common.enableCommandSnapshot) return;
        ...
        private void SnapshotBattleState(string preffix = null)
        {
            ...
            var logStr = $"t:{clientTick} " +
                ...
                $"\n====snapshot====\n{snapshot}\n==============\n " +
                $"\n";
            GameHelper_Common.FileLog(GameFacade_Common.commandSnapshotLogName, logStr);
